...
let test_timestamp () =
  ...
  check_data "date+time" (Ion.Timestamp "2003-12-01T00:00:00Z")
    "2003-12-01T00:00:00Z";
  check_data "date+time+frac" (Ion.Timestamp "2003-12-01T00:00:00.000Z")
    "2003-12-01T00:00:00.000Z";
  check_data "date+time+offset" (Ion.Timestamp "2003-12-01T08:30:00+08:00")
  ...
  check_data "nested sexp"
    (Ion.Sexp
       [
         Ion.symbol "*";
         Ion.sexp
           [ Ion.symbol "+"; Ion.int_ (Z.of_int 1); Ion.int_ (Z.of_int 2) ];
         Ion.int_ (Z.of_int 3);
       ])
    "(* (+ 1 2) 3)"
